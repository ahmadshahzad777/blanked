...
CREATE_TABLE_LINKS += 'id INT AUTO_INCREMENT, ';
...
CREATE_TABLE_LINKS += 'enabled BOOLEAN NOT NULL, ';
CREATE_TABLE_LINKS += 'created_on TIMESTAMP NOT NULL, ';
...
CREATE_TABLE_USERS += 'id INT AUTO_INCREMENT, ';
